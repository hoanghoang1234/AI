...
class PacManState:
    ...
    def successors(self):
        ...
        for key in move_direction.keys():
            relation_x = self.x+move_direction[key][0]
            relation_y = self.y+move_direction[key][1]
            relation_direction = move_direction[key][2]
            state = [relation_x, relation_y, relation_direction]
